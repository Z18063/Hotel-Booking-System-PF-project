...
int durations[MAX_RESERVATIONS]; 
...
int main() 
{
    ...
    do  
    {
        ...
        switch (choice) 
        {
            ...
            case 3:
            	system("color F8");
                viewReservationDetails();//0 = Black       8 = Gray
    //1 = Blue        9 = Light Blue
...
void bookRoom(Room rooms[], int size) 
{
    ...
    int totalBill = calculateTotalBill(reservations[reservationCount][2], durations[reservationCount]);
